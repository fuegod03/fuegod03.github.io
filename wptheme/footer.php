...
$font_link=$mypod->field("font_link");
$font_link2=$mypod->field("font_link2");
$font_link3=$mypod->field("font_link3");
$font_link4=$mypod->field("font_link4");
 ?>
...
<?php echo $contact_address; ?>
 ...
 <img src="<?php echo $contact_right_logo; ?>" alt="">
   ...
   <div class="social-container">
     <a href="<?php echo $font_link; ?>"  target="_blank"">
       <i class="<?php echo $font_icon; ?>"></i>
     </a>
     <a href="<?php echo $font_link2;?>" target="_blank"">
       <i class="<?php echo $font_icon2; ?>"></i>
     </a>
     <a href="<?php echo $font_link3; ?>" target="_blank"">
       <i class="<?php echo $font_icon3; ?>"></i>
     </a>
     <a href="<?php echo $font_link4; ?>" target="_blank"">
